  ...
  return (
    <div className="rounded-3xl bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 border border-slate-800 p-6 sm:p-8 shadow-2xl space-y-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-5">
        <div>
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#074c88]/25 text-[#f9c701] border border-[#074c88]/40 text-xs font-bold font-mono">
        ...
        <div className="text-right self-start sm:self-auto">
          ...
          <span className="text-sm font-bold text-[#f9c701]">{t('Pro Tier ฿2,490/เดือน', 'Pro Tier ฿2,490/mo')}</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="space-y-2.5">
          <div className="flex justify-between items-center text-xs">
            ...
            <span className="font-bold text-[#f9c701] font-mono text-base">{lanes} {t('เลน', 'Lanes')}</span>
          </div>
          <input
            type="range"
            min={2}
            ...
            className="w-full accent-[#074c88] cursor-pointer h-2 bg-slate-800 rounded-lg"
          />
        ...
        <div className="space-y-2.5">
          <div className="flex justify-between items-center text-xs">
            ...
            <span className="font-bold text-[#f9c701] font-mono text-base">฿{avgHourlyRate}</span>
          </div>
          <input
            type="range"
            min={150}
        ...
        <div className="space-y-2.5">
          <div className="flex justify-between items-center text-xs">
            ...
            <span className="font-bold text-[#f9c701] font-mono text-base">{dailyHoursOpen} {t('ชม.', 'hrs')}</span>
          </div>
          <input
            type="range"
            min={6}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
        <div className="p-5 rounded-2xl bg-[#074c88]/20 border border-[#074c88]/40 space-y-1">
          <span className="text-xs font-semibold text-[#f9c701] flex items-center justify-between">
        ...
        <div className="p-5 rounded-2xl bg-slate-950 border border-slate-800 space-y-1">
          <span className="text-xs font-semibold text-slate-300 flex items-center justify-between">
            ...
            <Sparkles className="w-4 h-4 text-[#f9c701]" />
          </span>
          <div className="text-2xl sm:text-3xl font-black text-[#f9c701]">
      ...
      <div className="pt-2 flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-slate-800">
        <div className="flex items-center gap-2 text-xs text-slate-400">
          <CheckCircle2 className="w-4 h-4 text-[#f9c701] shrink-0" />
        ...
        <Link
          href="/register-shop"
          className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#074c88] to-[#10516e] hover:from-[#09599e] hover:to-[#146487] text-white font-bold text-xs flex items-center gap-1.5 shadow-md shadow-[#074c88]/30 transition-all self-stretch sm:self-auto justify-center"
        >
