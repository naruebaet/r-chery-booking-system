export const INITIAL_SHOPS = [
    ...
    },
    {
        ...
        membershipPlans: [
            {
                id: 'az-mem-1',
                name: 'Chiang Mai Resident Club Pass',
                type: 'monthly_unlimited',
                price: 2200,
                validityDays: 30,
                perks: ['ใช้สนามกลางแจ้งได้ทุกวัน', 'ฟรีที่จอดรถและล็อกเกอร์']
            }
        ]
    }
];
export const INITIAL_BOOKINGS = [
    {
        id: 'bkg-1001',
        bookingCode: 'RB-98421',
        shopId: 'shop-robin-bkk',
        customerLineId: 'U1234567890',
        customerName: 'คุณ ธนพล (Robin Pro)',
        ...
        laneDistance: '18m',
        addons: {
            equipment: [{ id: 'eq-3', name: 'ชุดคันธนู Recurve Intermediate (24 lbs - ถนัดขวา)', price: 150, details: '24 lbs R' }],
            coach: { id: 'coach-1', name: 'โค้ชเอก (อดีตนักกีฬาทีมชาติ)', price: 300 }
        },
